...
<Project Type="Project" LVVersion="21008000">
	...
	<Property Name="NI.Project.Description" Type="Str">This project contains software (Main.vi) to measure calibration datapoints for resistive temperature sensors. Please follow instructions in it.
It uses Temperature controler model 350 from Lake Shore Cryotronics to measure temperature of calibrated standard and control temperature.
Up to two uncalibrated sensors can be measured by two source meter units (SMU Keithley 2450).
Data are saved in TDMS file. To create file with calibration curve, please follow video in documentation.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			...
			<Item Name="How to create calibration file in 2 minutes.mp4" Type="Document" URL="../documentation/How to create calibration file in 2 minutes.mp4"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Data.ctl" Type="VI" URL="../controls/Data.ctl"/>
			<Item Name="State.ctl" Type="VI" URL="../controls/State.ctl"/>
			<Item Name="SMU settings.ctl" Type="VI" URL="../controls/SMU settings.ctl"/>
		</Item>
		<Item Name="subVIs" Type="Folder">
			<Item Name="Set measurement.vi" Type="VI" URL="../subVIs/Set measurement.vi"/>
			<Item Name="Connect and setup SMU.vi" Type="VI" URL="../subVIs/Connect and setup SMU.vi"/>
			<Item Name="Read TC.vi" Type="VI" URL="../subVIs/Read TC.vi"/>
			<Item Name="Create meas file with date.vi" Type="VI" URL="../subVIs/Create meas file with date.vi"/>
			<Item Name="Generate tmp points.vi" Type="VI" URL="../subVIs/Generate tmp points.vi"/>
		</Item>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="Temperature sensors calibration.vi" Type="VI" URL="../miscelous VIs/Temperature sensors calibration.vi"/>
		<Item Name="Save datapoint2.vi" Type="VI" URL="../subVIs/Save datapoint2.vi"/>
		<Item Name="Read SMU.vi" Type="VI" URL="../subVIs/Read SMU.vi"/>
		<Item Name="Simple main.vi" Type="VI" URL="../Simple main.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Save datapoint.vi" Type="VI" URL="../subVIs/Save datapoint.vi"/>
		</Item>
